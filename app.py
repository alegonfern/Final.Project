...
#aca debe ir la función para conectar base de datos en sqlite3, por ejemplo en mongodb (archivo conect_db.py) se llama a la funcion 
# connect_db()

#flujo de inicio de sesión y dinamica de oauth2 
